...
# Profile only the first real prefill at or above the configured token threshold.
[ -n "${FREETOKEN_PREFILL_PROFILE:-}" ] && export FREETOKEN_PREFILL_PROFILE
[ -n "${FREETOKEN_PREFILL_PROFILE_MIN_TOKENS:-}" ] && export FREETOKEN_PREFILL_PROFILE_MIN_TOKENS
