            ...
            if len(detokenize_msg) > 0:
                ...
                sampled_replies = [
                    UserReply(
                        ...
                        spec_accepted_total=msg.spec_accepted_total,
                        spec_drafted_total=msg.spec_drafted_total,
                        spec_blocks_total=msg.spec_blocks_total,
                        spec_accepted_per_pos=msg.spec_accepted_per_pos,
                    )
